...
namespace DigitsPower
{
    ...
    class SimpleMul : BinaryPow
    {
        public SimpleMul(string found, string degree, string mod, string by) : base(found, degree, mod, by) { }

        public override string Name() { return "Simple mul"; }
        protected override void LoopFunc(BigInteger found, BigInteger pow, BigInteger mod) { PowFunctions.mul(found, pow, mod); }
    }
